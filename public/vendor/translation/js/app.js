!(function (e) {
    ...
    function (e, t, n) {
        ...
        r
            ...
            (window.Vue = n(29)),
            Vue.component("translation-input", n(33).default);
        new Vue({
            el: "#app",
            data: function () {
    ...
    function (e, t, n) {
        ...
        (function (t, n) {
            ...
            var z,
                ...
                Q =
                    (W && W.indexOf("android"),
                    (W && /iphone|ipad|ipod|ios/.test(W)) || "ios" === X),
                ee =
                    (W && /chrome\/\d+/.test(W),
                    W && /phantomjs/.test(W),
                    W && W.match(/firefox\/(\d+)/)),
            ...
            function Lt(e, t, n, i, o) {
                ...
                (this.data = e),
                    ...
                    (this.slots = function () {
                        return (
                            c.$slots ||
                                vt(e.scopedSlots, (c.$slots = pt(n, i))),
                            c.$slots
                        );
                    }),
                        ...
                        if (a(e.options.functional))
                            return (function (e, t, n, i, a) {
                                ...
                                if (o(u))
                                    ...
                                    o(n.attrs) && It(c, n.attrs),
                                        o(n.props) && It(c, n.props);
                                var f = new Lt(n, c, a, i, e),
                                    p = s.render.call(null, f._c, f);
                                if (p instanceof he)
                                    return Nt(p, n, f.parent, s);
                                if (Array.isArray(p)) {
                                    for (
                                        var d = ut(p) || [],
                ...
                var n = (function (e) {
                    if (
                        ...
                        return (yr = e.lastIndexOf(".")) > -1
                            ...
                            : { exp: e, key: null };
                    for (mr = e, yr = _r = br = 0; !Br(); )
                        Ur((gr = Fr())) ? zr(gr) : 91 === gr && Hr(gr);
            ...
            function mi(e) {
                if (e) {
                    if ("object" == typeof e) {
                        var t = {};
                        return (
                            !1 !== e.css && T(t, gi(e.name || "v")), T(t, e), t
                        );
                    }
            ...
            yi &&
                (void 0 === window.ontransitionend &&
                    ...
                    ((wi = "WebkitTransition"), (xi = "webkitTransitionEnd")),
                void 0 === window.onanimationend &&
                    void 0 !== window.onwebkitanimationend &&
                    (($i = "WebkitAnimation"), (Ci = "webkitAnimationEnd")));
            var Ai = K
            ...
            function Ki(e) {
                e.target.composing &&
                    ((e.target.composing = !1), Ji(e.target, "input"));
            }
            function Ji(e, t) {
            ...
            (xn.config.mustUseProp = jn),
                ...
                T(xn.options.directives, Wi),
                T(xn.options.components, so),
                (xn.prototype.__patch__ = K ? Fi : j),
                        ...
                        if (
                            ...
                            if (s) {
                                ...
                                (p.slotTarget = l),
                                    ...
                                    (p.children = e.children.filter(function (
                                        e
                                    ) {
                                        if (!e.slotScope)
                                            return (e.parent = p), !0;
            ...
            var va,
                ...
                ga = {
                    ...
                    directives: {
                        ...
                        text: function (e, t) {
                            t.value &&
                                Sr(e, "textContent", "_s(" + t.value + ")", t);
                        },
                        html: function (e, t) {
                            t.value &&
                                Sr(e, "innerHTML", "_s(" + t.value + ")", t);
                        },
                    },
                    isPreTag: function (e) {
                        return "pre" === e;
            ...
            var Ta = {
                ...
                Ea = function (e) {
                    (this.options = e),
                        (this.warn = e.warn || Ar),
                        (this.transforms = kr(e.modules, "transformCode")),
                        (this.dataGenFns = kr(e.modules, "genData")),
            ...
            function Pa(e) {
                return (
                    1 === e.type && ("slot" === e.tag || e.children.some(Pa))
                );
            }
            function Fa(e, t) {
            ...
            var Ja,
                ...
                Wa = ((Ja = function (e, t) {
                    var n = (function (e, t) {
                        (Mo = t.warn || Ar),
                            (Uo = t.isPreTag || L),
                            (Ho = t.mustUseProp || L),
                            (zo = t.getTagNamespace || L),
                            t.isReservedTag,
                            (Po = kr(t.modules, "transformNode")),
                            (Fo = kr(t.modules, "preTransformNode")),
                            (Bo = kr(t.modules, "postTransformNode")),
                            (Ro = t.delimiters);
                        var n,
                            r,
                            i = [],
                ...
                Ga = (Wa.compile, Wa.compileToFunctions);
            function Za(e) {
                return (
        ...
        var r = (function (e, t, n, r, i, o, a, s) {
            ...
            function () {
                var e = this,
                    t = e.$createElement,
                    n = e._self._c || t;
                return n("div", { staticClass: "flex custom-section" }, [
                    n("textarea", {
                        directives: [
                            {
                                name: "model",
                        ...
                        ref: "trans",
                        staticClass: "form-control custom-textbox",
                        class: { active: e.isActive },
                        attrs: { rows: "1" },
                        domProps: { value: e.translation },
                        on: {
                            focus: e.setActive,
                            blur: e.storeTranslation,
                            input: function (t) {
                                t.target.composing ||
                                    (e.translation = t.target.value);
                            },
                        },
                    }),
                    e._v(" "),
                    n(
                        "svg",
                        {
                            ...
                            staticClass:
                                "cursor-pointer fill-current icon-primary w-4 h-4 custom-icon",
                            attrs: {
                    ...
                    n(
                        "svg",
                        {
                            ...
                            staticClass:
                                "cursor-pointer fill-current icon-success w-4 h-4 custom-icon",
                            attrs: {
                                xmlns: "http://www.w3.org/2000/svg",
                                viewBox: "0 0 20 20",
                            },
                    ...
                    n(
                        "svg",
                        {
                            ...
                            staticClass:
                                "cursor-pointer fill-current icon-danger w-4 h-4 custom-icon",
                            attrs: {
                                xmlns: "http://www.w3.org/2000/svg",
                                viewBox: "0 0 20 20",
                            },
                            ...
                            directives: [
                                {
                                    ...
                                    expression:
                                        "!isActive && !hasSaved && !hasErrored && !isLoading",
                                },
                            ],
                            staticClass:
                                "cursor-pointer fill-current icon-gray w-4 h-4 custom-icon",
                            attrs: {
                                xmlns: "http://www.w3.org/2000/svg",
                                viewBox: "0 0 20 20",
                            },

                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-xl-4">
                                            <div class="mb-3">
                                                <label class="form-label">{{ __('Billing Country') }}</label>


                                                <select value="{{ Auth::user()->billing_country }}" name="billing_country"
                                                    class="form-control">
                                                    ...
                                                    <option {{ Auth::user()->billing_country == 'Chad' ? 'selected' : '' }}
                                                    ...
                                                    <option {{ Auth::user()->billing_country == 'Cuba' ? 'selected' : '' }}
                                                    ...
                                                    <option
                                                        ...
                                                        'Micronesia, Federated
                                                            ...
                                                            ? 'selected'
                                                            : '' }}
                                                        value="Micronesia, Federated States of">Micronesia, Federated
                                                        States
                                                        of</option>
                                                    <option

            ...
            <div class="container-xl">
                ...
                <div class="row row-deck row-cards">
                    <div class="col-sm-12 col-lg-12">
                        <form action="{{ route('user.save.testimonial', Request::segment(3)) }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div id="testimonial" class="row">
                                            <div id="more-testimonial" class="row mt-3"></div>

                                            <div class="col-lg-12">
                                                <button type="button" onclick="addTestimonial()" class="btn btn-primary">
                                                    {{ __('Add One More Testimonial') }}
                                                </button>
                                            </div>
        ...
        <script>
            ...
            function addTestimonial() {
                ...
                if (count >= {{ $plan_details->no_testimonials }}) {
                    ...
                    var testimonial = "<div class='row' id='" + id + "'>" +
                        "<div class='col-md-6 col-xl-6'>" +
                            "<div class='mb-3'>" +
                                "<label class='form-label required'>" + 
                                    "{{ __('Reviewer Image') }} <span class='text-muted'>({{ __('Recommended : 200 x 200 pixels') }})</span>" + 
                                "</label>" +
                                "<div class='input-group mb-2'>" +
                                    "<input type='text' class='image" + id + " media-model form-control' name='reviewer_image[]' placeholder='{{ __('Reviewer Image') }}' required>" +
                        ...
                        "<div class='col-md-6 col-xl-6'>" +
                            "<div class='mb-3'>" +
                                "<label class='form-label required'>" +
                                    "{{ __('Reviewer Name') }}" +
                                "</label>" +
                                "<input type='text' class='form-control' name='reviewer_name[]' maxlength='191' placeholder='{{ __('Reviewer Name') }}' required>" +
                            "</div>" +
                        "</div>" +
                        "<div class='col-md-6 col-xl-6'>" +
                            "<div class='mb-3'>" +
                                "<label class='form-label required'>" +
                                    "{{ __('Reviewer Subtext') }}" +
                                "</label>" +
                                "<input type='text' class='form-control' name='review_subtext[]' placeholder='{{ __('Reviewer Subtext') }}' required>" +
                            "</div>" +
                        "</div>" +
                        "<div class='col-md-6 col-xl-6'>" +
                            "<div class='mb-3'>" +
                                "<label class='form-label required'>" +
                                    "{{ __('Review') }}" +
                                "</label>" +
                                "<input type='text' class='form-control' name='review[]' placeholder='{{ __('Review') }}' required>" +
                                "<a href='#' class='btn mt-3 btn-danger btn-sm' onclick='removeTestimonial(" + id + ")'>" +
                                    "{{ __('Remove') }}" +
                                "</a>" +
                            "</div>" +
                            "<br>" +

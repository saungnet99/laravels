        ...
        <div class="container-xl">
            ...
            <div class="row row-deck row-cards">
                <div class="col-md-12 col-xl-12">
                    <form action="{{ route('user.save.social.links', Request::segment(3)) }}" id="myForm" method="post"
                        class="card">
                        @csrf
                        <div class="card-body">
                            <div class="row">
...
<script>
            ...
            var features = `<div class='row' id=` + id + `>
                                ...
                                <div class='col-auto'>
                                    <div class='mb-3 mt-2'>
                                        ...
                                        <input type='hidden' class='icon`+ id +` form-control' placeholder='{{ __('Choose Icon') }}' name='icon[]' value='fab fa-facebook' required readonly>
                                    </div>
                                </div>
                                ...
                                <div class='col-lg-4 col-md-4'>
                                    <div class='mb-3 mt-2'>
                                        ...
                                        <input type='text' class='lbl`+ id +` form-control' name='label[]' placeholder='{{ __('Label') }}' value='Facebook' required>
                                    </div>
                                </div>
                                ...
                                <div class='col-lg-4 col-md-4'>
                                    <div class='mb-3 mt-2'>
                                        ...
                                        <input type='text' class='textlbl`+ id +` form-control' name='value[]' placeholder='{{ __('Type something') }}' autofocus required>
                                    </div>
                                </div>
    ...
    if(count == 1){
        ...
        title: `{{ __('Oops!') }}`,
        icon: 'warning',
        text: `{{ __('Please add at least one bio link.') }}`,
        timer: 2000,
        buttons: false,
        showConfirmButton: false,
    });
    ...
    function dynamicSelect(id) {
        "use strict";
        var el;
        window.TomSelect && (new TomSelect(el = document.getElementById('type'+id), {

                    ...
                    <div class="col-12 col-md-3 border-end">
                        <div class="card-body">
                            ...
                            <div class="list-group list-group-transparent">
                                {{-- Nav links --}}
                                @include('user.pages.edit-cards.includes.nav-link', ['link' => 'galleries'])
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-9 d-flex flex-column">
                        <form action="{{ route('user.update.galleries', Request::segment(3)) }}" method="post" enctype="multipart/form-data" id="myForm">
                            @csrf
                            <div class="card-body">
                                <h3 class="card-title mb-4">{{ __('Galleries') }}</h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="row" id="{{ $i }}">
                                        <div class="col-md-6 col-xl-6">
                                            <div class="mb-3">
                                                <label class="form-label required">{{ __('Gallery Image') }} <span
                            ...
                            <div class="card-footer bg-transparent mt-auto">
                                <div class="btn-list justify-content-end">
                                    ...
                                    <a href="{{ route('user.edit.testimonials', Request::segment(3)) }}" class="btn btn-primary">
                                        {{ __('Skip') }}
                                    </a>

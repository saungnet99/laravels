@extends('vendor.installer.layouts.installation')
        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
                ...
                <div class="form-group {{ $errors->has('purchase_code') ? ' has-error ' : '' }}">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="purchase_code" id="purchase_code"
                            value="{{ old('purchase_code') }}" onkeypress="return /[0-9a-zA-Z-]/i.test(event.key)"
                ...
                <div class="form-group {{ $errors->has('environment') ? ' has-error ' : '' }}">
                    <div class="mb-3">
                        ...
                        <select name="environment" id="environment" onchange='checkEnvironment(this.value);'
                            ...
                            <option value="local"
                                {{ $server_name == 'localhost' && $server_name == '127.0.0.1' && $url == 'test' ? 'selected' : '' }}>
                        ...
                        <div>
                            <label class="form-check">
                                <input class="form-check-input" name="app_debug" id="app_debug_true" value=true
                                    type="radio">
                                <span
                                    class="form-check-label">{{ trans('installer_messages.environment.wizard.form.app_debug_label_true') }}</span>
                            </label>
                            <label class="form-check">
                                <input class="form-check-input" name="app_debug" id="app_debug_false" value=false checked
                                    type="radio">
                                <span
                                    class="form-check-label">{{ trans('installer_messages.environment.wizard.form.app_debug_label_false') }}</span>
                            </label>
                        </div>
                    </div>
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="form-group {{ $errors->has('database_hostname') ? ' has-error ' : '' }}">
                    <div class="mb-3">
                        <label class="form-label">
                            {{ trans('installer_messages.environment.wizard.form.db_host_label') }}</label>
                        <input type="text" class="form-control" name="database_hostname" id="database_hostname"
                            value="127.0.0.1" value="{{ old('database_hostname') }}"
                ...
                <div class="form-group {{ $errors->has('database_port') ? ' has-error ' : '' }}">
                    <div class="mb-3">
                        <label class="form-label">
                            {{ trans('installer_messages.environment.wizard.form.db_port_label') }}</label>

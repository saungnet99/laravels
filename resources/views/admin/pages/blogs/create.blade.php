            ...
            <div class="container-xl">
                ...
                <div class="row row-deck row-cards">
                    ...
                    <div class="col-sm-12 col-lg-12">
                        <form action="{{ route('admin.publish.blog') }}" method="post" enctype="multipart/form-data" class="card">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control text-capitalize" name="blog_name" id="blog_name" maxlength="200" placeholder="{{ __('Eg: Blog title') }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="blog_slug" id="blog_slug" maxlength="200" placeholder="{{ __('Eg: blog-url') }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-xl-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control text-capitalize" name="short_description" id="short_description" placeholder="{{ __('Eg: Blog title') }}" cols="30" rows="3" required></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-xl-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="long_description" id="long_description" cols="30" rows="5" class="form-control text-capitalize" placeholder="{{ __('Description') }}"></textarea>
                                                </div>
                                            </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" placeholder="{{ __('Choose a category') }}" name="category_id" id="category_id" required>
                                                        ...
                                                        @foreach ($blogsCategories as $blogsCategory)
                                                            <option value="{{ $blogsCategory->blog_category_id }}"{{ $blogsCategory->blog_category_id == '66087535342' ? 'selected' : '' }}>{{ __($blogsCategory->blog_category_title) }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="tags" id="tags" placeholder="{{ __('tag 1, tag 2') }}" required>
                                            ...
                                            <div class="col-md-12 col-xl-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="seo_keywords" placeholder="{{ __('Keywords') }}"
                                                        required />
                                                </div>
                                            </div>
                                        </div>

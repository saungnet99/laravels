        ...
        <div class="container-xl">
            ...
            <div class="row row-deck row-cards">
                <div class="col-sm-12 col-lg-12">
                    <form action="{{ route('admin.store.coupon') }}" method="post" class="card">
                        @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xl-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control text-uppercase" name="code" value="{{ old('code') }}" placeholder="{{ __('Coupon Code') }}" autocomplete="code" autofocus required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-xl-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control text-capitalize" name="description" value="{{ old('description') }}" placeholder="{{ __('Description') }}" autocomplete="description" autofocus>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-xl-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control discount" name="discount" value="{{ old('discount') }}" min="0" step="0.001" placeholder="{{ __('Discount') }}" autocomplete="discount" autofocus required>
                                        ...
                                        <div class="col-md-6 col-xl-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" name="validity" value="{{ old('validity') ?? date('Y-m-d') }}" placeholder="{{ __('Validity') }}" autocomplete="validity" autofocus required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-xl-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" name="user_limit" value="{{ old('user_limit') ?? 1 }}" min="1" step="1" placeholder="{{ __('User Limit') }}" autocomplete="user_limit" autofocus required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-xl-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" name="total_limit" value="{{ old('total_limit') ?? 1 }}" min="1" step="1" placeholder="{{ __('Total Limit') }}" autocomplete="total_limit" autofocus required>
                                            </div>
                                        </div>
                                    </div>
                                </div>

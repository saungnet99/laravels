...
'title' => __('Random Word Generator - Web Tools')])
        ...
        <div class="container px-5 py-12 mx-auto">
            ...
            <form action="{{ route('web.result.random.word.generator')}}" method="post">
                ...
                <div class='mb-3 space-y-2 w-full'>
                    ...
                    <input type="number" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter font-mono text-base text-black rounded-lg h-10 px-4" name="words" id="words" placeholder="{{ __('No. of Words')}}">
                </div>
            ...
            @if (isset($results))
                <div class='mb-3 space-y-2 w-full'>
                    ...
                    <textarea class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter font-mono text-base text-black rounded-lg h-48 px-4 py-2" name="result" id="result" placeholder="{{ __('Result')}}" >{{ $results }}</textarea>
                </div>

@extends('layouts.index', ['nav' => true, 'banner' => false, 'footer' => true, 'cookie' => false, 'setting' => false, 'title' => true, 'title' => __('500 - Internal Server Error')])
    ...
    <div class="relative container mx-auto lg:px-24 px-4">
        <div class="relative z-10">
            ...
            <div class="md:max-w-xl">
                <h2 class="mb-11 font-heading font-bold text-6xl sm:text-7xl text-gray-900">{{ __('Internal Server Error') }}</h2>
                <button

...
<body class="antialiased text-body font-body lg:bg-pink-500"
                            ...
                            <div class="relative {{ $business_card_details->cover_type == 'photo' ? 'py-2' : '' }}">
                                    ...
                                    items-center">
                                                    <div class="flex items-center">
                                                        <div class="w-1/8">
                                                            {{-- Icon --}}
                                                            <span
                                                                class="flex justify-center items-center content-center bg-pink-500 hover:bg-pink-600 shadow-md hover:shadow-lg h-10 w-10 mr-3 rounded fill-current text-white">
                                ...
                                <div class="flex flex-wrap -mx-2">
                                    ...
                                    <div class="w-full md:w-full px-2 lg:mb-1 mb-1 md:mb-0">
                                        <a class="flex qr-modal-open justify-center py-2 text-sm text-white bg-pink-500 hover:bg-pink-600 rounded transition duration-200"
                                            href="">
                                    ...
                                    <div class="w-full md:w-full px-2 lg:mt-1 mt-1 md:mb-0">
                                        <a class="flex send-modal-open justify-center py-2 text-sm text-white bg-pink-500 hover:bg-pink-600 rounded transition duration-200"
                                            href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        @if ($enquiry_button != null)
                                                            @if (($whatsAppNumberExists == true && $whatsAppNumberExists == true) && $service_detail->enable_enquiry == 'Enabled')
                                                                <div
                                                                    ...
                                                                    <a class="w-full py-2 px-2 bg-pink-500 hover:bg-pink-600 rounded text-xs text-white"
                                        ...
                                        <div class="-mx-2">
                                            <div class="pt-6">
                                                @if (Session::has('message'))
                                                    <div class="px-2 bg-pink-500 hover:bg-pink-600 border-t-4 border-pink-500 rounded-b text-pink-900 px-4 py-3 shadow-md mb-3"
                                                        role="alert">
                                                        <div class="flex">
                                                            <div class="py-1"><svg
                                                ...
                                                <form class="px-2" action="{{ route('sent.enquiry') }}"
                                                    ...
                                                    <div class="text-center">
                                                        <button
                                                            class="mb-2 w-full py-4 bg-pink-500 hover:bg-pink-600 text-sm rounded font-bold text-gray-50 transition duration-200">
                                                            {{ __('Send') }}
                                                        </button>
                                                    </div>
                                                </form>
                            ...
                            <div class="lg:py-5 pt-5">
                                ...
                                <div class="flex flex-wrap pt-6 -mx-2">
                                    ...
                                    <div class="w-full lg:py-1 px-2 mb-2 md:mb-0">
                                        <a class="flex justify-center py-2 text-sm text-white bg-pink-500 hover:bg-pink-600 rounded transition duration-200"
                ...
                <div
                    ...
                    <div class="modal-content py-4 text-left px-6">
                        <div class="justify-between items-center">
                            ...
                            <button
                                class="flex justify-center items-center content-center bg-pink-500 hover:bg-pink-600 shadow-md hover:shadow-lg h-8 w-auto py-2 px-8 rounded fill-current text-white"
                                onclick="sendVcard()">
                                {{ __('Send') }}
                            </button>
                        </div>
                ...
                <div
                    ...
                    <div class="modal-content py-4 text-left px-6">
                        ...
                        <a id="download"
                            ...
                            class="mt-3 cursor-pointer w-full flex justify-center items-center content-center bg-pink-500 hover:bg-pink-600 shadow-lg hover:shadow-lg h-8 w-8 mr-4 rounded fill-current text-white qr-code-download">

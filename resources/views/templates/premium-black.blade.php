...
<body class="antialiased bg-grey-lighter text-body font-body"
            ...
            @if ($business_card_details != null)
                <div id="profile" class="leading-tight min-h-screen lg:bg-cover lg:bg-scroll shadow-xl">
                    ...
                    <div
                                                    ...
                                                    @if (($whatsAppNumberExists == true && $whatsAppNumberExists == true) && $service_detail->enable_enquiry == 'Enabled')
                                                        <div class="mt-5 mb-2">
                                                            <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product/service:') }} {{ $service_detail->service_name }}. {{ __('Please provide more details.') }}"
                                                                rel="noopener nofollow noreferrer" target="_blank"
                                                                class="sub-heading w-full block text-center bg-black font-semibold hover:bg-black text-white antialiased px-4 py-2">
                                                                {{ __('Make Inquiry') }}
                                                            </a>
                                                        </div>
                                                    @endif
                                                    ...
                                                    @if ($whatsAppNumberExists == true && $product_detail->product_status == 'instock')
                                                        <div class="mt-3 mb-2">
                                                            <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product:') }} {{ $product_detail->product_name }}. {{ __('Please provide more details.') }}"
                                                                rel="noopener nofollow noreferrer" target="_blank"
                                                                class="sub-heading w-full block text-center flex-1 bg-black font-semibold hover:bg-black text-white antialiased px-4 py-2">
                                                                {{ __('Make Inquiry') }}
                                                            </a>
                                                        </div>
                                                    @endif
                        ...
                        @if ($plan_details['business_hours'] == 1)
                            @if ($business_hours != null && $business_hours->is_display != 0)
                                ...
                                <div class="px-5 py-4">
                                    ...
                                    @else
                                        <div>
                                            <p class="pt-2 py-4 font-semibold text-black">{{ __('Always Open') }}</p>
                                        </div>
                                    @endif
                                </div>
                            @endif
                                    ...
                                    <div class="container mx-auto">
                                        <div class="max-w-xl mx-auto">
                                            @if (Session::has('message'))
                                                <div class="px-4 bg-black border-t-4 border-black rounded-b text-black px-4 py-3 shadow-md mb-3"
                                                    role="alert">
                                                    <div class="flex">
                                                        <div class="py-1"><svg
                                            ...
                                            <form class="px-4" action="{{ route('sent.enquiry') }}"
                                                ...
                                                <div class="text-center">
                                                    <button
                                                        class="mb-2 sub-heading w-full py-4 bg-black font-bold text-gray-50 transition duration-200">
                                                        {{ __('Send') }}
                                                    </button>
                                                </div>
                                            </form>
                        ...
                        <div id="share" class="bg-black w-full mt-4 mb-4 flex justify-center align-middle py-2">
                    ...
                    <div class="modal-container bg-white w-full md:max-w-md mx-auto rounded z-50 overflow-y-auto">
                        <div class="modal-content py-4 text-left px-6">
                            <div class="justify-between items-center">
                                ...
                                <button
                                    class="mt-6 block w-full sub-heading content-center bg-black py-2 px-8 fill-current text-white"
                                    onclick="sendVcard()">
                                    {{ __('Send') }}
                                </button>
                            </div>
    ...
    @if ($business_card_details->password != null && Session::get('password_protected') == false)
        <div class="bg-black p-4 flex items-center justify-center h-screen">
                            ...
                            <form action="{{ route('check.pwd', $business_card_details->card_id) }}" method="post">
                                ...
                                <div class="flex">
                                    <input type="password" name="password"
                                        class="rounded rounded-r-lg bg-gray-50 border text-gray-800 focus:ring-black-100 focus:border-black-100 block flex-1 min-w-0 w-full text-sm border-gray-100 p-2.5"

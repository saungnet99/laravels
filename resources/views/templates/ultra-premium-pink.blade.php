...
<body class="antialiased bg-grey-lighter text-body font-body"
    ...
    <div id="content" class="hidden">
        ...
        @if ($business_card_details->password == null || Session::get('password_protected') == true)
            @if ($business_card_details != null)
                                    ...
                                    <ul
                                        ...
                                        <li>
                                            <div class="flex items-center">
                                                <div
                                                    class="ml-4 flex justify-center items-center content-center  bg-pink-700  h-12 w-12 rounded-full fill-current text-white">
                                                    ...
                                                    @if (($whatsAppNumberExists == true && $whatsAppNumberExists == true) && $service_detail->enable_enquiry == 'Enabled')
                                                        <div class="mt-5 mb-2">
                                                            <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product/service:') }} {{ $service_detail->service_name }}. {{ __('Please provide more details.') }}"
                                                                rel="noopener nofollow noreferrer" target="_blank"
                                                                class="w-full block text-center rounded-full bg-pink-600 font-semibold hover:bg-pink-700 text-white antialiased px-4 py-2">
                                                                {{ __('Make Inquiry') }}
                                                            </a>
                                                        </div>
                                                    @endif
                                                    ...
                                                    @if ($whatsAppNumberExists == true && $product_detail->product_status == 'instock')
                                                        <div class="mt-3 mb-2">
                                                            <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product:') }} {{ $product_detail->product_name }}. {{ __('Please provide more details.') }}"
                                                                rel="noopener nofollow noreferrer" target="_blank"
                                                                class="w-full block text-center flex-1 rounded-full bg-pink-600 font-semibold hover:bg-pink-700 text-white antialiased px-4 py-2">
                                                                {{ __('Make Inquiry') }}
                                                            </a>
                                                        </div>
                                                    @endif
                                ...
                                <ul class="grid grid-flow-col grid-cols-1 grid-rows-1 mb-1">
                                    ...
                                    <li>
                                        <div class="flex items-center w-full px-5 ">
                                            <div
                                                class="flex justify-center items-center content-center bg-pink  h-12 w-12 rounded-full fill-current text-white">
                        ...
                        @if ($plan_details['business_hours'] == 1)
                            @if ($business_hours != null && $business_hours->is_display != 0)
                                ...
                                <div class="px-5 py-4">
                                    ...
                                    @else
                                        <div>
                                            <p class="pt-2 py-4 font-semibold text-pink-700">{{ __('Always Open') }}
                                            </p>
                                        </div>
                                    @endif
                                </div>
                                    ...
                                    <div class="container mx-auto">
                                        <div class="max-w-xl mx-auto">
                                            @if (Session::has('message'))
                                                <div class="px-4 bg-pink-700 border-t-4 border-pink-500 rounded-b text-pink-700 px-4 py-3 shadow-md mb-3"
                                                    role="alert">
                                                    <div class="flex">
                                                        <div class="py-1"><svg
                                            ...
                                            <form class="px-4" action="{{ route('sent.enquiry') }}"
                                                ...
                                                <div class="text-center">
                                                    <button
                                                        class="mb-2 w-full py-4 bg-pink-700 text-sm rounded-full font-bold text-gray-50 transition duration-200">
                                                        {{ __('Send') }}
                                                    </button>
                                                </div>
                                            </form>
                        ...
                        <div class="lg:block hidden w-full pl-6 pb-3 mx-auto pt-3 border-b">
                            <ul class="grid grid-flow-col grid-cols-6 grid-rows-1">
                                ...
                                <li class="flex send-modal-open cursor-pointer items-center">
                                    <div
                                        class="flex justify-center items-center content-center bg-pink-700  h-16 w-16 rounded-full fill-current text-white">
                            ...
                            <ul class="grid grid-flow-col lg:grid-cols-8 grid-cols-6 grid-rows-1">
                                ...
                                <a target="_blank" rel="noopener nofollow noreferrer"
                                    ...
                                    <li class="flex cursor-pointer items-center">
                                        <div
                                            class="flex justify-center items-center content-center bg-pink-700 h-12 w-12 rounded-full fill-current text-white">
                ...
                <div class="lg:hidden bg-pink-700 fixed bottom-0 w-full border-t border-gray-200 flex z-10">
                    <a href="#profile"
                        class="flex flex-grow items-center justify-center p-2 text-gray-50 hover:text-gray-50 bg-pink-700">
                        <div class="text-center">
                    ...
                    {{-- Send vCard --}}
                    <a href="#"
                        class="flex send-modal-open flex-grow items-center justify-center p-2 text-gray-50 hover:text-gray-50 bg-pink-700">
                        <div class="text-center">
                            <span class="block h-8 grid justify-items-center text-3xl leading-8">
                    ...
                    {{-- Scan QR --}}
                    <a href="#"
                        class="flex qr-modal-open flex-grow items-center justify-center p-2 text-gray-50 hover:text-gray-50 bg-pink-700">
                        <div class="text-center">
                            <span class="block h-8 grid justify-items-center text-3xl leading-8">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div
                        ...
                        <div class="modal-content py-4 text-left px-6">
                            <div class="justify-between items-center">
                                ...
                                <button
                                    class="flex justify-center items-center content-center bg-pink-700 h-14 w-12 py-2 px-8 fill-current text-white"
                                    onclick="sendVcard()">
                                    {{ __('Send') }}
                                </button>
                            </div>
                    ...
                    <div
                        ...
                        <div class="modal-content py-4 text-left px-6">
                            ...
                            <a id="download"
                                ...
                                class="mt-3 cursor-pointer flex justify-center items-center content-center bg-pink-700 h-16 w-16 rounded-full fill-current text-white qr-code-download">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
    ...
    @if ($business_card_details->password != null && Session::get('password_protected') == false)
        <div class="bg-pink-50 p-4 flex items-center justify-center h-screen">
                        ...
                        <div class="mt-6 space-y-4">
                            <form action="{{ route('check.pwd', $business_card_details->card_id) }}" method="post">
                                ...
                                <div class="flex flex-col space-y-4 mt-3">
                                    <button type="submit"
                                        class="bg-pink-700 text-white px-4 py-2 mt-2 rounded-lg hover:bg-pink-700 transition duration-300">{{ __('Password') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>

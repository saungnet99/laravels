...
<head>
    ...
    <link rel="stylesheet" href="{{ url('templates/css/template-1.css') }}" />
...
<body class="antialiased text-body font-body lg:bg-purple-500"
    ...
    @if ($business_card_details->password == null || Session::get('password_protected') == true)
        {{-- Check business details --}}
        @if ($business_card_details != null)
            <section class="lg:py-5 bg-purple-500">
                <div class="lg:w-8/12 px-2 mx-auto">
                    <div class="flex flex-wrap template-1 -m-2">
                        <div class="w-full lg:w-1/2 bg-white p-4">
                            ...
                            <div class="relative {{ $business_card_details->cover_type == 'photo' ? 'py-2' : '' }}">
                                    ...
                                    <div class="block max-w-full py-2 mb-6">
                                        @foreach ($feature_details as $feature)
                                            ...
                                            @if ($feature->type != 'iframe' && $feature->type != 'youtube' && $feature->type != 'map' && $feature->type != 'text')
                                                <div
                                                    class="flex {{ $loop->last ? '' : 'mb-3' }} justify-between items-center">
                                ...
                                <div class="flex flex-wrap -mx-2">
                                    <!-- Add to Contact -->
                                    <div class="w-1/3 md:w-1/3 px-2 mb-2 md:mb-0">
                                                                ...
                                                                <div class="mt-2">
                                                                    <p class="text-sm text-gray-500 product-desc">
                                                                        ...
                                                                        @if ($product_detail->sales_price != $product_detail->regular_price)
                                                                            <span
                                                                                class="text-xs line-through text-red-500 font-bold">
                                        ...
                                        <div class="-mx-2">
                                            <div class="pt-6 px-2">
                                                <div class="w-full overflow-hidden rounded-lg">
                                                    <iframe class="w-full h-64 text-white"
                                                        src="{{ $iframe->content }}" frameborder="0"></iframe>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                @if ($feature->type == 'map')
                                                    <div class="-mx-2">
                                                        <div class="pt-6 px-2">
                                                            ...
                                                            <h3 class="mb-2 text-xl font-bold">{{ $feature->label }}
                                                            </h3>
                                                        </div>
                                                    </div>
                                                @endif
                            ...
                            <div class="py-5">
                                ...
                                <div class="flex flex-wrap pt-6 -mx-2">
                                    <!-- Facebook -->
                                    <div class="w-1/5 md:w-1/5 px-2 my-2 md:mb-0">
                                        <a class="flex justify-center py-2 text-sm text-white bg-purple-500 hover:bg-purple-600 rounded transition duration-200"
                ...
                <div
                    ...
                    <div class="modal-content py-4 text-left px-6">
                        ...
                        <a id="download"
                            ...
                            class="mt-3 cursor-pointer w-full flex justify-center items-center content-center bg-purple-500 hover:bg-purple-600 shadow-lg hover:shadow-lg h-8 w-8 rounded fill-current text-white qr-code-download">
    ...
    <script src="{{ url('templates/js/template-1.js') }}"></script>

...
@php
    ...
    $business_card_details->theme_color = 'pink';
@endphp
        ...
        @if ($business_card_details->password == null || Session::get('password_protected') == true)
            @if ($business_card_details != null)
                <div id="profile" class="leading-tight min-h-screen lg:bg-cover lg:bg-scroll shadow-xl"
                    style="background: url('/images/patterns/heart.png')">

                    <div class="lg:p-2"></div>

                    <div
                        class="max-w-xl w-full mx-auto bg-white rounded-lg overflow-hidden shadow-lg relative {{ $business_card_details->cover ? '' : 'pt-10' }}">

                        {{-- Cover Photo --}}
                        @if ($business_card_details->cover_type == 'photo')
                            <div class="bottom-style-6">
                        ...
                        <div class="border-b px-4 pt-3 flex flex-row">
                            <div class="text-center -mt-2 sm:text-left sm:flex mb-2  w-1/2">
                                <img class="profile-style-8 h-24 w-24 border-2 border-white mr-4 md:ml-24 lg:ml-12 profile"
                        ...
                        @if ($business_card_details->description != null || $business_card_details->address != null)
                            <div class="pb-3 pt-3 px-5 text-gray-800 text-left border-b">
                        ...
                        <div class="grid lg:grid-cols-2">
                            ...
                            @foreach ($feature_details as $feature)
                                @if ($feature->type != 'iframe' && $feature->type != 'youtube' && $feature->type != 'map' && $feature->type != 'text')
                                    <ul
                                        class="bg-white transition ease-in-out border rounded-xl m-3 hover:shadow-xl hover:transition-all">
                                        ...
                                        <li>
                                            <div class="flex items-center">
                                                <div
                                                    class="ml-4 flex justify-center items-center content-center  bg-indigo-700  h-12 w-12 rounded-full fill-current text-white">
                                                    <i class="{{ $feature->icon }}"></i>
                                                </div>
                                                <div class="w-2/4 mx-2 my-6">
                                                    <p class="font-semibold text-gray-800 break-word text-lg">
                                                        {{ $feature->label }}</p>
                        ...
                        @if ($customTexts != null && !$customTexts->isEmpty())
                            @foreach ($customTexts as $customText)
                                <div class="ribbon-1 w-full my-5 mb-4 flex justify-center align-middle py-2">
                                    <p class="font-black mb-6 text-xl px-4 py-1">{{ __($customText->label) }}</p>
                                </div>
                                <div class="pb-3 pt-3 px-5 py-5 my-5">
                                    <p class="text-gray-800">{{ $customText->content }}</p>
                                </div>
                            @endforeach
                        @endif
                        ...
                        @if ($service_details != null && !$service_details->isEmpty())
                            <div class="ribbon-1 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                <p class="font-black mb-6 text-xl px-4 py-1">{{ __('Services') }}</p>
                            </div>
                                                    ...
                                                    @if (($whatsAppNumberExists == true && $whatsAppNumberExists == true) && $service_detail->enable_enquiry == 'Enabled')
                                                        <div class="mt-5 mb-2">
                                                            <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product/service:') }} {{ $service_detail->service_name }}. {{ __('Please provide more details.') }}"
                                                                rel="noopener nofollow noreferrer" target="_blank"
                                                                class="w-full block text-center rounded-full bg-indigo-600 font-semibold hover:bg-indigo-700 text-white antialiased px-4 py-2">
                                                                {{ __('Make Inquiry') }}
                                                            </a>
                                                        </div>
                                                    @endif
                        ...
                        @if ($product_details != null && !$product_details->isEmpty())
                            ...
                            <div class="ribbon-1 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                <p class="font-black mb-6 text-xl px-4 py-1">{{ __('Products') }}</p>
                            </div>
                                                    ...
                                                    @if ($whatsAppNumberExists == true && $product_detail->product_status == 'instock')
                                                        <div class="mt-3 mb-2">
                                                            <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product:') }} {{ $product_detail->product_name }}. {{ __('Please provide more details.') }}"
                                                                rel="noopener nofollow noreferrer" target="_blank"
                                                                class="w-full block text-center flex-1 rounded-full bg-indigo-600 font-semibold hover:bg-indigo-700 text-white antialiased px-4 py-2">
                                                                {{ __('Make Inquiry') }}
                                                            </a>
                                                        </div>
                                                    @endif
                        ...
                        @if ($testimonials != null && !$testimonials->isEmpty())
                            <div class="ribbon-1 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                <p class="font-black mb-6 text-xl px-4 py-1">{{ __('Testimonials') }}</p>
                            </div>
                        ...
                        @if ($feature_details != null && !$feature_details->isEmpty())
                            @foreach ($feature_details as $feature)
                                @if ($feature->type == 'youtube')
                                    <div class="ribbon-1 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                        <p class="font-black mb-6 text-xl px-4 py-1">{{ __('Videos') }}</p>
                                    </div>
                        ...
                        @if ($iframes != null && !$iframes->isEmpty())
                            @foreach ($iframes as $iframe)
                                <div class="ribbon-1 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                    <p class="font-black mb-6 text-xl px-4 py-1">{{ __($iframe->label) }}</p>
                                </div>
                        ...
                        @if (count($payment_details) > 0)
                            ...
                            <div class="ribbon-1 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                <p class="font-black mb-6 text-xl px-4 py-1">{{ __('Payment Details') }}</p>
                            </div>
                                ...
                                <ul class="grid grid-flow-col grid-cols-1 grid-rows-1 mb-1">
                                    ...
                                    <li>
                                        <div class="flex items-center w-full px-5 ">
                                            <div
                                                class="flex justify-center items-center content-center bg-indigo  h-12 w-12 rounded-full fill-current text-white">
                                                <i class="{{ $payment->icon }}"></i>
                                            </div>
                                            @if ($payment->type != 'upi')
                                                <div class="w-3/4 mx-5 my-6">
                                                    <p class="font-semibold break-word text-gray-800 text-lg">
                                                        {{ $payment->label }}</p>
                        ...
                        @if ($plan_details['business_hours'] == 1)
                            @if ($business_hours != null && $business_hours->is_display != 0)
                                ...
                                <div class="ribbon-1 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                    <p class="font-black mb-6 text-xl px-4 py-1">{{ __('Business Hours') }}</p>
                                </div>
                                ...
                                <div class="px-5 py-4">
                                    ...
                                    @if ($business_hours->is_always_open != 'Opening')
                                        <div>
                                            <p class="pt-2 font-semibold text-gray-800">{{ __('Monday') }}:
                                                {{ __($business_hours->monday) }}</p>
                                            <p class="pt-2 font-semibold text-gray-800">{{ __('Tuesday') }}:
                                                {{ __($business_hours->tuesday) }}</p>
                                            <p class="pt-2 font-semibold text-gray-800">{{ __('Wednesday') }}:
                                                {{ __($business_hours->wednesday) }}</p>
                                            <p class="pt-2 font-semibold text-gray-800">{{ __('Thursday') }}:
                                                {{ __($business_hours->thursday) }}</p>
                                            <p class="pt-2 font-semibold text-gray-800">{{ __('Friday') }}:
                                                {{ __($business_hours->friday) }}</p>
                                            <p class="pt-2 font-semibold text-gray-800">{{ __('Saturday') }}:
                                                {{ __($business_hours->saturday) }}</p>
                                            <p class="pt-2 font-semibold text-gray-800">{{ __('Sunday') }}:
                                                {{ __($business_hours->sunday) }}</p>
                                        </div>
                                    @else
                                        <div>
                                            <p class="pt-2 py-4 font-semibold text-indigo-700">
                                                {{ __('Always Open') }}</p>
                                        </div>
                                    @endif
                                </div>
                        ...
                        @if ($plan_details['contact_form'] == 1)
                            @if ($business_card_details->enquiry_email != null)
                                ...
                                <div class="ribbon-1 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                    <p class="font-black mb-6 text-xl px-4 py-1">{{ __('Contact us') }}</p>
                                </div>
                                    ...
                                    <div class="container mx-auto">
                                        <div class="max-w-xl mx-auto">
                                            @if (Session::has('message'))
                                                <div class="px-4 bg-indigo-700 border-t-4 border-indigo-500 rounded-b text-indigo-700 px-4 py-3 shadow-md mb-3"
                                                    role="alert">
                                                    <div class="flex">
                                                        <div class="py-1"><svg
                                            ...
                                            <form class="px-4" action="{{ route('sent.enquiry') }}"
                                                ...
                                                <div class="text-center">
                                                    <button
                                                        class="mb-2 w-full py-4 bg-indigo-700 text-sm rounded-full font-bold text-gray-50 transition duration-200">
                                                        {{ __('Send') }}
                                                    </button>
                                                </div>
                                            </form>
                        ...
                        @if ($feature_details != null && !$feature_details->isEmpty())
                            <div id="youtube" class="py-4">
                                @foreach ($feature_details as $feature)
                                    @if ($feature->type == 'map')
                                        <div class="ribbon-1 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                            <p class="font-black mb-6 text-xl px-4 py-1">{{ __('Location') }}</p>
                                        </div>
                        ...
                        <div class="lg:block hidden w-full pl-6 pb-3 mx-auto pt-3 border-b">
                            <ul class="grid grid-flow-col grid-cols-6 grid-rows-1">
                                ...
                                <li class="flex send-modal-open cursor-pointer items-center">
                                    <div
                                        class="flex justify-center items-center content-center bg-indigo-700  h-16 w-16 rounded-full fill-current text-white">
                        ...
                        <div id="share" class="ribbon-1 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                            <p class="font-black mb-6 text-xl px-4 py-1">{{ __('Share on') }}</p>
                        </div>
                            ...
                            <ul class="grid grid-flow-col lg:grid-cols-8 grid-cols-6 grid-rows-1">
                                ...
                                <a target="_blank" rel="noopener nofollow noreferrer"
                                    ...
                                    <li class="flex cursor-pointer items-center">
                                        <div
                                            class="flex justify-center items-center content-center bg-indigo-700 h-12 w-12 rounded-full fill-current text-white">
                        ...
                        @if ($plan_details['hide_branding'] == 1)
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2">
                                        {{ __('Copyright') }} &copy;
                                        <a class="text-indigo-700" href="{{ url($card_details->card_url) }}">
                        ...
                        @else
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2">
                                        {{ __('Made with') }}
                                        <a class="text-indigo-700" href="{{ env('APP_URL') }}">
                                            {{ config('app.name') }} </a>
                                        <span id="year"></span>{{ __('. All Rights Reserved.') }}
                                    </div>
                                </div>
                ...
                <div class="lg:hidden bg-indigo-700 fixed bottom-0 w-full border-t border-gray-200 flex z-10">
                    <a href="#profile"
                        class="flex flex-grow items-center justify-center p-2 text-gray-50 hover:text-gray-50 bg-indigo-700">
                        <div class="text-center">
                    ...
                    {{-- Send vCard --}}
                    <a href="#"
                        class="flex send-modal-open flex-grow items-center justify-center p-2 text-gray-50 hover:text-gray-50 bg-indigo-700">
                        <div class="text-center">
                            <span class="block h-8 grid justify-items-center text-3xl leading-8">
                    ...
                    {{-- Scan QR --}}
                    <a href="#"
                        class="flex qr-modal-open flex-grow items-center justify-center p-2 text-gray-50 hover:text-gray-50 bg-indigo-700">
                        <div class="text-center">
                            <span class="block h-8 grid justify-items-center text-3xl leading-8">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div
                        ...
                        <div class="modal-content py-4 text-left px-6">
                            <div class="justify-between items-center">
                                ...
                                <button
                                    class="flex justify-center items-center content-center bg-indigo-700 h-14 w-12 py-2 px-8 fill-current text-white"
                                    onclick="sendVcard()">
                                    {{ __('Send') }}
                                </button>
                            </div>
                    ...
                    <div
                        ...
                        <div class="modal-content py-4 text-left px-6">
                            ...
                            <a id="download"
                                ...
                                class="mt-3 cursor-pointer flex justify-center items-center content-center bg-indigo-700 h-16 w-16 rounded-full fill-current text-white qr-code-download">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                        ...
                        <div class="mt-6 space-y-4">
                            <form action="{{ route('check.pwd', $business_card_details->card_id) }}" method="post">
                                ...
                                <div class="flex flex-col space-y-4 mt-3">
                                    <button type="submit"
                                        class="bg-indigo-700 text-white px-4 py-2 mt-2 rounded-lg hover:bg-indigo-700 transition duration-300">{{ __('Password') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>

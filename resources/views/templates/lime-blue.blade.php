...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cabin:wght@500;600;700&display=swap" rel="stylesheet">
...
@php
    ...
    $business_card_details->theme_color = 'lime-800';
@endphp
        ...
        @if ($business_card_details->password == null || Session::get('password_protected') == true)
            @if ($business_card_details != null)
                <div id="profile" class="leading-tight min-h-screen lg:bg-cover lg:bg-scroll shadow-xl">
                    ...
                    <div
                        class="max-w-xl w-full mx-auto bg-white rounded-lg overflow-hidden shadow-lg relative {{ $business_card_details->cover ? '' : 'pt-48' }}">

                        {{-- Cover Photo --}}
                        @if ($business_card_details->cover_type == 'photo')
                            <div class="bottom-style-8">
                        ...
                        @if ($business_card_details->description != null || $business_card_details->address != null)
                            <div class="pb-3 pt-3 px-5 text-gray-800 border-b">
                        ...
                        <div class="grid lg:grid-cols-3 grid-cols-2">
                            ...
                            @foreach ($feature_details as $feature)
                                @if ($feature->type != 'iframe' && $feature->type != 'youtube' && $feature->type != 'map' && $feature->type != 'text')
                                    <ul
                                        class="bg-white transition ease-in-out border-2 rounded-lg  m-3 hover:shadow-xl hover:transition-all pb-4">
                                        ...
                                        <li>
                                            ...
                                            <div class="text-center">
                                                <p
                                                    class="font-semibold text-gray-800 break-word text-xs p-2 sub-heading">
                                                    {{ $feature->label }}</p>
                        ...
                        @if ($customTexts != null && !$customTexts->isEmpty())
                            @foreach ($customTexts as $customText)
                                <div class="w-full px-5 align-middle py-2 border-t border-b">
                        ...
                        @if ($service_details != null && !$service_details->isEmpty())
                            ...
                            <div class="px-5 py-4 grid grid-cols-2 gap-2">
                                @foreach ($service_details as $service_detail)
                                    <div class="mb-3">
                                        <div class="w-full overflow-hidden border-2 rounded-lg ">
                                        ...
                                        <div class="p-4 bg-white border-2 rounded-lg ">
                                            ...
                                            <div class="w-full mb-1 justify-between items-center">
                                                <h4 class="lg:text-xl text-md font-black mb-3 text-dark mt-2 flex">
                                                    <p class="lg:text-xl text-sm font-black lg:mr-3">
                                                        <span class="mr-1"
                        ...
                        @if ($galleries_details != null && !$galleries_details->isEmpty())
                            ...
                            <div id="gallery" class="px-5 py-4 bg-cover bg-scroll grid grid-cols-2 gap-2">
                                @foreach ($galleries_details as $galleries_detail)
                                    <div class="mb-3">
                                        <div class="w-full overflow-hidden bg-white border-2 rounded-lg ">
                        ...
                        @if ($iframes != null && !$iframes->isEmpty())
                            @foreach ($iframes as $iframe)
                                ...
                                <div id="youtube" class="py-4 ">
                                    <div class="mb-3">
                                        <div class="mx-5 overflow-hidden border-2 rounded-lg ">
                                ...
                                <ul class="grid grid-flow-col grid-cols-1 grid-rows-1 mb-1">
                                    ...
                                    <li>
                                        <div class="flex items-center w-full px-5 ">
                                            ...
                                            @if ($payment->type == 'upi')
                                                <div class="w-3/4 mx-5 my-6">
                                                    <p class="font-semibold break-word text-gray-800 text-lg sub-heading">{{ $payment->label }}</p>

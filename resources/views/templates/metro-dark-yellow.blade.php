        ...
        @if ($business_card_details->password == null || Session::get('password_protected') == true)
            @if ($business_card_details != null)
                <div id="profile" class="leading-tight min-h-screen p-1">
                    ...
                    <div
                        class="max-w-xl w-full mx-auto bg-black overflow-hidden shadow-lg relative {{ $business_card_details->cover_type == 'photo' ? '' : 'pt-24' }}">
                            ...
                            @foreach ($customTexts as $customText)
                                ...
                                <div class="px-5 py-4">
                                    <div class="w-full my-6">
                                        ...
                                        <p class="font-semibold text-white break-word text-sm">{{ $feature->content }}
                                        </p>
                                    </div>
                                </div>
                            @endforeach
                        ...
                        @if ($iframes != null && !$iframes->isEmpty())
                            <div id="iframe" class="py-4">
                                @foreach ($iframes as $iframe)
                                    ...
                                    <div id="iframe" class="py-4">
                                        <div class="mb-3">
                                            <div class="mx-5 overflow-hidden rounded-lg shadow-lg">
                        ...
                        <div id="share" class="w-full px-5 align-middle py-4 border-t">

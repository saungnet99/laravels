    ...
    <div>
        ...
        @if ($business_card_details->password == null || Session::get('password_protected') == true)
            @if ($business_card_details != null)
                        ...
                        @if ($plan_details['business_hours'] == 1)
                            @if ($business_hours != null && $business_hours->is_display != 0)
                                ...
                                <div class="px-5 py-4">
                                    ...
                                    @else
                                        <div>
                                            <p class="pt-2 py-4 font-semibold text-pink-500">{{ __('Always Open') }}
                                            </p>
                                        </div>
                                    @endif
                                </div>
                ...
                <div class="lg:hidden bg-pink-800 fixed bottom-0 w-full border-white flex z-10">

                    {{-- Scan QR --}}
                    <a href="#"
                        class="flex qr-modal-open flex-grow items-center justify-center p-2 text-gray-50 hover:text-gray-50 bg-pink-800 cursor">
                        <div class="text-center">
                    ...
                    {{-- Send vCard --}}
                    <a href="#"
                        class="flex send-modal-open flex-grow items-center justify-center p-2 text-gray-50 hover:text-gray-50 bg-pink-800 cursor">
                        <div class="text-center">
                            <span class="block h-8 grid justify-items-center text-3xl leading-8">
                    ...
                    {{-- Download vCard --}}
                    <a href="{{ route('download.vCard', $business_card_details->card_id) }}"
                        class="flex flex-grow items-center justify-center p-2 text-white hover:text-white bg-pink-800">
                        <div class="text-center">
                            <span class="block h-8 grid justify-items-center text-3xl leading-8">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">

                    ...
                    <div class="nav-item dropdown">
                        <div class="nav-item">
                            <a class="position-relative cursor-pointer text-white" data-bs-toggle="modal"
                                ...
                                <span class="badge bg-red text-red-fg badge-notification badge-pill"
                                    id="badge">0</span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="container-xl">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 pt-6 px-1">
                            <h3 class="alert alert-important alert-red">{{ $business_card_details->sub_title }}</h3>
                        </div>
                                        ...
                                        <div class="col-sm-6 col-lg-3 col-6 py-2">
                                            <div class="card custom-card-style">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <span
                                                        class="badge bg-red text-white">{{ $product->badge }}</span>
                            ...
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item"><a href="{{ $shareComponent['facebook'] }}"
                                        target="_blank" class="link-light"><i
                                            class="ti ti-brand-facebook-filled text-red"></i></a></li>
                                <li class="list-inline-item"><a href="{{ $shareComponent['twitter'] }}"
                                        class="link-light"><i class="ti ti-brand-twitter-filled text-red"></i></a>
                                </li>
                                <li class="list-inline-item"><a href="{{ $shareComponent['linkedin'] }}"
                                        target="_blank" class="link-light"><i
                                            class="ti ti-brand-linkedin text-red"></i></a></li>
                                <li class="list-inline-item"><a href="{{ $shareComponent['telegram'] }}"
                                        target="_blank" class="link-light"><i
                                            class="ti ti-brand-telegram text-red"></i></a></li>
                                <li class="list-inline-item"><a href="{{ $shareComponent['whatsapp'] }}"
                                        target="_blank" class="link-light"><i
                                            class="ti ti-brand-whatsapp text-red"></i></a></li>
                            </ul>
                        </div>
                            ...
                            <ul class="list-inline list-inline-dots mb-0">
                                ...
                                @else
                                    <li class="list-inline-item">
                                        {{ __('Copyright') }} &copy; <span id="year"></span> <a
                                            href="{{ url($business_card_details->card_url) }}"
                                            class="link-light text-red"><strong>{{ config('app.name') }}</strong></a>.
                                        {{ __('All rights reserved.') }}
                                    </li>
                                @endif
                            </ul>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <a class="btn btn-red" id="place-order"
                    ...
                    <div id="empty-cart" class="pt-6 p-3">
                        ...
                        <a class="btn btn-red d-flex" data-bs-dismiss="modal"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-red" data-bs-dismiss="modal">{{ __('Close') }}</button>
    ...
    <script>
        ...
        function updateList() {
            ...
            cart.forEach((item, index) => {
                ...
                cart_items +=
                    `<a onclick="reduceQty(${index})" class="btn btn-red flex-fill mb-1 ${window.innerWidth <= 768 ? 'btn-sm' : 'mx-2'}">-</a>`;
                cart_items +=
                    `<a class="btn btn-white flex-fill mb-1 ${window.innerWidth <= 768 ? 'btn-sm' : 'mx-2'}">${item.qty}</a>`;
                cart_items +=
                    `<a onclick="addQty(${index})" class="btn btn-red flex-fill mb-1 ${window.innerWidth <= 768 ? 'btn-sm' : 'mx-2'}">+</a>`;
                cart_items +=
                    `<a onclick="removeFromCart(${index})" class="btn btn-red flex-fill mb-1 ${window.innerWidth <= 768 ? 'btn-sm' : 'mx-2'}">x</a>`;
                cart_items += `</div>`;
                cart_items += `</div>`;
                cart_items += `</div>`;
                cart_items += `</div>`;
        ...
        function updateBadge() {
            ...
            if (badgeCount > 0) {
                ...
                $("#place-order").show().attr("class", "btn btn-red d-flex");
            } else {
                $("#place-order").hide().attr("class", "btn btn-red d-none");
                $("#badge").hide();
                $("#empty-cart").show();
            }
        }

...
@php
    ...
    $business_card_details->theme_color = 'black';
@endphp
...
<body class="antialiased bg-grey-lighter text-body font-body"
    ...
    <div id="content" class="hidden">
        ...
        @if ($business_card_details->password == null || Session::get('password_protected') == true)
            @if ($business_card_details != null)
                <div id="profile" class="leading-tight min-h-screen lg:bg-cover lg:bg-scroll shadow-xl">
                    ...
                    <div
                        ...
                        <div class="border-b px-4 pt-3 flex flex-row">
                            <div class="text-center -mt-2 sm:text-left sm:flex mb-2  w-1/2 z-[0]">
                        ...
                        @if ($business_card_details->description != null || $business_card_details->address != null)
                            <div class="pb-3 pt-3 px-5 text-left text-gray-800 border-b">
                                {!! $business_card_details->description !!}
                            </div>
                        @endif


                        <div class="lg:grid-cols-2 grid-cols-1">
                        ...
                        @if ($customTexts != null && !$customTexts->isEmpty())
                            @foreach ($customTexts as $customText)
                                <div class="bg-black w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                    <p class="heading font-black text-white text-xl px-4">{{ __($customText->label) }}
                                    </p>
                                </div>

                                <div class="px-5 py-2">
                                    <div class="w-full">
                                        <p class="pb-3 pt-3 text-gray-800 border-bg">
                        ...
                        @if ($service_details != null && !$service_details->isEmpty())
                            <div class="bg-pink-700 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                                    ...
                                                    @if (($whatsAppNumberExists == true && $whatsAppNumberExists == true) && $service_detail->enable_enquiry == 'Enabled')
                                                        <div class="mt-5 mb-2">
                                                            <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product/service:') }} {{ $service_detail->service_name }}. {{ __('Please provide more details.') }}"
                                                                rel="noopener nofollow noreferrer" target="_blank"
                                                                class="sub-heading w-full block text-center bg-pink-700 font-semibold hover:bg-pink-700 text-white antialiased px-4 py-2">
                                                                {{ __('Make Inquiry') }}
                                                            </a>
                                                        </div>
                                                    @endif
                                ...
                                @foreach ($product_details as $product_detail)
                                    <div class="w-full lg:w-full p-2">
                                        <div class="p-4 bg-white border-2 rounded-lg">
                                            ...
                                            <b
                                                class="py-1 px-2 bg-red-700 rounded text-white">{{ $product_detail->badge }}</b>
                                                    ...
                                                    @if ($whatsAppNumberExists == true && $product_detail->product_status == 'instock')
                                                        <div class="mt-3 mb-2">
                                                            <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product:') }} {{ $product_detail->product_name }}. {{ __('Please provide more details.') }}"
                                                                rel="noopener nofollow noreferrer" target="_blank"
                                                                class="sub-heading w-full block text-center flex-1 bg-pink-700 font-semibold hover:bg-pink-700 text-white antialiased px-4 py-2">
                                                                {{ __('Make Inquiry') }}
                                                            </a>
                                                        </div>
                                                    @endif
                                    ...
                                    <li>
                                        <div class="flex items-center w-full px-5 ">
                                            ...
                                            @if ($payment->type == 'upi')
                                                <div class="w-3/4 mx-5 my-6">
                                                    <p
                                                        class="font-semibold break-word text-gray-800 text-lg sub-heading mb-2">
                                                        {{ $payment->label }}</p>
                        ...
                        @if ($plan_details['business_hours'] == 1)
                            @if ($business_hours != null && $business_hours->is_display != 0)
                                ...
                                <div class="px-5 py-4">
                                    ...
                                    @else
                                        <div>
                                            <p class="pt-2 py-4 font-semibold text-pink">{{ __('Always Open') }}</p>
                                        </div>
                                    @endif
                                </div>
                            @endif
                                    ...
                                    <div class="container mx-auto">
                                        <div class="max-w-xl mx-auto">
                                            @if (Session::has('message'))
                                                <div class="px-4 bg-pink-700 border-t-4 border-pink rounded-b text-pink px-4 py-3 shadow-md mb-3"
                                                    role="alert">
                                                    <div class="flex">
                                                        <div class="py-1"><svg
                                            ...
                                            <form class="px-4" action="{{ route('sent.enquiry') }}"
                                                ...
                                                <div class="text-center">
                                                    <button
                                                        class="mb-2 sub-heading w-full py-4 bg-pink-700 font-bold text-gray-50 transition duration-200">
                                                        {{ __('Send') }}
                                                    </button>
                                                </div>
                                            </form>
                        ...
                        @if ($feature_details != null && !$feature_details->isEmpty())
                            <div id="youtube" class="py-4">
                                @foreach ($feature_details as $feature)
                                    @if ($feature->type == 'map')
                                        <div
                                            class="bg-pink-700 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                            <p class="heading font-black text-white  text-xl px-4 py-2">
                                                {{ __('Location') }}</p>
                                        </div>
                        ...
                        @if ($plan_details['hide_branding'] == 1)
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2">
                                        {{ __('Copyright') }} &copy;
                                        <a class="text-pink" href="{{ url($card_details->card_url) }}">
                        ...
                        @else
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2">
                                        {{ __('Made with') }}
                                        <a class="text-pink" href="{{ env('APP_URL') }}"> {{ config('app.name') }}
                                        </a>
                                        <span id="year"></span>{{ __('. All Rights Reserved.') }}
                                    </div>
                                </div>
                    ...
                    <div class="modal-container bg-white w-full md:max-w-md mx-auto rounded z-50 overflow-y-auto">
                        <div class="modal-content py-4 text-left px-6">
                            <div class="justify-between items-center">
                                ...
                                <button
                                    class="mt-6 block w-full sub-heading content-center bg-pink-700 py-2 px-8 fill-current text-white"
                                    onclick="sendVcard()">
                                    {{ __('Send') }}
                                </button>
                            </div>
                ...
                {{-- QR --}}
                <div class="qr-modal opacity-0 transition duration-300 ease-in-out  pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center"
                    style="z-index: 9999;">
    ...
    @if ($business_card_details->password != null && Session::get('password_protected') == false)
        <div class="bg-pink-700 p-4 flex items-center justify-center h-screen">

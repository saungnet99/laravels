                                ...
                                @if ($feature->type != 'iframe' && $feature->type != 'youtube' && $feature->type != 'map' && $feature->type != 'text')
                                    <li>
                                        <div class="flex items-center w-full px-5 ">
                                            <div
                                                class="flex justify-center items-center content-center bg-gradient-to-br from-pink-300 to-pink-800 shadow-md hover:shadow-lg h-12 w-12 fill-current text-white">
                                                    ...
                                                    @if (($whatsAppNumberExists == true && $whatsAppNumberExists == true) && $service_detail->enable_enquiry == 'Enabled')
                                                        <div class="mt-5 mb-2">
                                                            <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product/service:') }} {{ $service_detail->service_name }}. {{ __('Please provide more details.') }}"
                                                                rel="noopener nofollow noreferrer" target="_blank"
                                                                class="flex-1 bg-pink-500 font-semibold hover:bg-pink-800 text-white antialiased px-4 py-2">
                                        ...
                                        <div class="w-full overflow-hidden shadow-lg">
                                            <a href="{{ url($galleries_detail->gallery_image) }}"
                                                ...
                                                <img class="w-full" src="{{ url($galleries_detail->gallery_image) }}"
                                                    alt="{{ $galleries_detail->caption }}" style="width: 100%; height: 350px; object-fit: cover;" style="width: 100%; height: 350px; object-fit: cover;" />
                                            </a>
                                            <div class="px-5 py-3">
                                                <div class="mb-2">
                        ...
                        <div class="lg:block hidden w-full pl-6 pb-3 mx-auto pt-3 border-t">
                            <ul class="grid grid-flow-col grid-cols-6 grid-rows-1">
                                ...
                                <li class="flex send-modal-open cursor-pointer items-center">
                                    <div
                                        class="flex justify-center items-center content-center bg-gradient-to-br from-pink-300 to-pink-800 shadow-md hover:shadow-lg h-16 w-16 fill-current text-white">
                    ...
                    <div class="modal-container bg-white w-auto md:max-w-md mx-auto shadow-lg z-50 overflow-y-auto">
                        <div class="modal-content py-4 text-left px-6">
                            ...
                            <a id="download"
                                ...
                                class="cursor-pointer flex justify-center items-center content-center bg-gradient-to-br from-pink-300 to-pink-800 shadow-md hover:shadow-lg h-16 w-16 fill-current text-white qr-code-download">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />

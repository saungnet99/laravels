...
<body class="antialiased text-body font-body lg:bg-blue-500"
    ...
    @if ($business_card_details->password == null || Session::get('password_protected') == true)
        {{-- Check business details --}}
        @if ($business_card_details != null)
            <section class="lg:py-5 bg-blue-500">
                        ...
                        <div class="w-full lg:w-1/2 bg-white p-4">
                            ...
                            <div class="relative {{ $business_card_details->cover_type == 'photo' ? 'py-2' : '' }}">
                                ...
                                @if (count($feature_details) > 0)
                                    <div class="block max-w-1/2 py-2 mb-6">
                ...
                <div
                    ...
                    <div class="modal-content py-4 text-left px-6">
                        ...
                        <a id="download"
                            ...
                            class="mt-3 cursor-pointer w-full flex justify-center items-center content-center bg-blue-500 hover:bg-blue-600 shadow-lg hover:shadow-lg h-8 w-8 rounded fill-current text-white qr-code-download">

        ...
        <div class="lg:w-8/12 px-2 mx-auto">
            <div class="flex flex-wrap template-4 -m-2">
                        ...
                        <div class="relative {{ $business_card_details->cover_type == "photo" ? 'pt-14' : 'pt-1' }} rounded overflow-hidden">
                            ...
                            <div class="flex flex-wrap -mx-2">
                                ...
                                <div class="w-1/2 md:w-1/2 px-2 mb-2 md:mb-0">
                                    <a
                                        class="flex qr-modal-open px-5 py-3 items-center justify-center bg-blue-500 hover:bg-blue-600 text-sm leading-6 font-bold text-white rounded-xl transition duration-200"
                                        href="#"
                                    >
                                ...
                                <div class="w-1/2 md:w-1/2 px-2 mb-2 md:mb-0">
                                    <a
                                        class="flex send-modal-open px-5 py-3 items-center justify-center bg-blue-500 hover:bg-blue-600 text-sm leading-6 font-bold text-white rounded-xl transition duration-200"
                                        href="#"
                                    >
                                ...
                                @foreach ($feature_details as $feature)
                                    @if ($feature->type != 'iframe' && $feature->type != 'youtube' && $feature->type != 'map' && $feature->type != 'text')
                                        <div class="w-1/2 md:w-1/3 px-2 mb-2 md:mb-0">
                                            ...
                                            <a class="flex px-5 py-3 items-center justify-center bg-blue-500 hover:bg-blue-600 text-sm leading-6 font-bold text-white rounded-xl transition duration-200" href="mailto:{{ $feature->content }}">
                                            @endif

                                            {{-- Tel --}}
                                            @if ($feature->type == 'tel')
                                            <a class="flex px-5 py-3 items-center justify-center bg-blue-500 hover:bg-blue-600 text-sm leading-6 font-bold text-white rounded-xl transition duration-200" href="tel:{{ $feature->content }}">
                                            @endif

                                            {{-- WhatsApp --}}
                                            @if ($feature->type == 'wa')
                                            <a class="flex px-5 py-3 items-center justify-center bg-blue-500 hover:bg-blue-600 text-sm leading-6 font-bold text-white rounded-xl transition duration-200" href="http://wa.me/{{ $feature->content }}" rel="noopener nofollow noreferrer" target="_blank">
                                            @endif
                                            ...
                                            <a class="flex px-5 py-3 items-center justify-center bg-blue-500 hover:bg-blue-600 text-sm leading-6 font-bold text-white rounded-xl transition duration-200" href="https://{{ str_replace('https://', '', $feature->content) }}" rel="noopener nofollow noreferrer" target="_blank">
                                            @endif
                        ...
                        <div class="lg:py-5 pt-5">
                            ...
                            <div class="flex flex-wrap pt-6 -mx-2">
                                ...
                                <div class="w-1/5 md:w-1/5 px-2 mb-2 md:mb-0">
                                    <a
                                        class="flex justify-center py-2 text-sm text-white bg-blue-500 hover:bg-blue-600 rounded-xl transition duration-200"
                ...
                <div class="w-full px-2 mb-2 md:mb-0 add-to-contact border-t shadow-lg lg:hidden">
                    <a
                    class="flex px-5 py-3 items-center justify-center bg-blue-500 hover:bg-blue-600 text-sm leading-6 font-bold text-white rounded-xl transition duration-200"
    ...
    <div
        ...
        <div class="modal-container bg-white w-auto md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
            <div class="modal-content py-4 text-left px-6">
                ...
                <a id="download" onclick="downloadQr('{{ route('dynamic.card', $business_card_details->card_id) }}', 500)" class="mt-3 cursor-pointer w-full flex justify-center items-center content-center bg-blue-500 hover:bg-blue-600 shadow-lg hover:shadow-lg h-8 w-8 rounded fill-current text-white qr-code-download">
                ...
                <div class="bg-white rounded-lg p-6 w-96 max-w-full shadow-lg transform transition-all duration-300" x-show.transition.opacity="showModal">
                    ...
                    <div class="mt-6 space-y-4">
                        <form action="{{ route('check.pwd', $business_card_details->card_id) }}" method="post">
                            ...
                            <div class="flex">
                                <input type="password" name="password" class="rounded rounded-r-lg bg-gray-50 border text-gray-800 focus:ring-blue-100 focus:border-blue-100 block flex-1 min-w-0 w-full text-sm border-gray-100 p-2.5" placeholder="{{ __('Password') }}" required>
                            </div>
                            ...
                            <div class="flex flex-col space-y-4 mt-3">
                                <button type="submit" class="bg-blue-500 text-white px-4 py-2 mt-2 rounded-lg hover:bg-blue-600 transition duration-300">{{ __('Password') }}</button>
                            </div>
                        </form>
                    </div>
                </div>

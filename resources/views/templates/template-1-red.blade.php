...
<body class="antialiased text-body font-body lg:bg-red-500"
    ...
    @if ($business_card_details->password == null || Session::get('password_protected') == true)
        {{-- Check business details --}}
        @if ($business_card_details != null)
            <section class="lg:py-5 bg-red-500">
                ...
                <div
                    ...
                    <div class="modal-content py-4 text-left px-6">
                        ...
                        <a id="download"
                            ...
                            class="mt-3 cursor-pointer w-full flex justify-center items-center content-center bg-red-500 hover:bg-red-600 shadow-lg hover:shadow-lg h-8 w-8 rounded fill-current text-white qr-code-download">

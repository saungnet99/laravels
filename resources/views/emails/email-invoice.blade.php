                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <table class="purchase_content" width="100%" cellpadding="0"
                                                            ...
                                                            @if ($details['applied_coupon'] != null)
                                                                <tr>
                                                                    <td width="80%" class="purchase_footer" valign="middle">
                                                                        <p
                                                                            class="f-fallback purchase_total purchase_total--label">
                                                                            {{ __('Coupon') }} : {{ $details['applied_coupon'] }}</p>
                                                                    </td>
                                                                    <td width="20%" class="purchase_footer" valign="middle">
                                                                        <p class="f-fallback purchase_total">
                                                                            - {{ $details['invoice_currency'] }} {{ $details['discounted_price'] }}</p>
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                            <tr>
                                            ...
                                            <p>{{ __('If you have any questions about this invoice, simply reply to this email or reach out to our') }} <a
                                                    href="mailto:{{ $details['from_billing_email'] }}">{{ __('support team') }}</a> {{ __('for help.') }}
                                            </p>
                                            <p>{{ __('Thanks') }},
                                                <br>{{ $details['from_billing_name'] }} {{ __('Team') }}</p>
                                            <!-- Sub copy -->
